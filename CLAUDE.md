...
You are encouraged to golf proofs where possible.

## Build times

You are encouraged to optimise the build time where possible, to ensure that the project does not take too long to compile from scratch.
